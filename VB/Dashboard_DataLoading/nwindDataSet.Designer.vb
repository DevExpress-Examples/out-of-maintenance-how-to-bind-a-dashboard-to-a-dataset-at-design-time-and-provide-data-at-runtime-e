...
Namespace Dashboard_DataLoading
    ...
    Partial Public Class nwindDataSet
        ...
        Partial Public Class SalesPersonDataTable
            ...
            <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(), Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")> _
            Public Function AddSalesPersonRow(ByVal Sales_Person As String, ByVal Extended_Price As Decimal, ByVal Discount As Single, ByVal Quantity As Short, ByVal UnitPrice As Decimal, ByVal CategoryName As String, ByVal ProductName As String) As SalesPersonRow
                Dim rowSalesPersonRow As SalesPersonRow = (DirectCast(Me.NewRow(), SalesPersonRow))
                Dim columnValuesArray() As Object = { Sales_Person, Extended_Price, Discount, Quantity, UnitPrice, CategoryName, ProductName}
    ...
    End Class
End Namespace
Namespace Dashboard_DataLoading.nwindDataSetTableAdapters
    ...
    Partial Public Class SalesPersonTableAdapter
        ...
        Private Sub InitCommandCollection()
            ...
            Me._commandCollection(0).CommandText = "SELECT        [Sales Person], [Extended Price], Discount, Quantity, UnitPrice, Ca" & "tegoryName, ProductName" & ControlChars.CrLf & "FROM            SalesPerson"
