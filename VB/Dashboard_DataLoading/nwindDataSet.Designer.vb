...
Namespace Dashboard_DataLoading.nwindDataSetTableAdapters
	...
	Partial Public Class SalesPersonTableAdapter
		...
		Private Sub InitCommandCollection()
			...
			Me._commandCollection(0).CommandText = "SELECT        [Sales Person], [Extended Price], Discount, Quantity, UnitPrice, Ca" & "tegoryName, ProductName" & Constants.vbCrLf & "FROM            SalesPerson"
