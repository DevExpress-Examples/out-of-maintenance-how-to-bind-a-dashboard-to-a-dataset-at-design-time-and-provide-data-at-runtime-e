...
Namespace Dashboard_DataLoading
    ...
    Partial Public Class nwindDataSet
        ...
        Partial Public Class SalesPersonDataTable
            ...
            <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(), Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")> _
            Public Function AddSalesPersonRow(ByVal Sales_Person As String, ByVal Extended_Price As Decimal, ByVal Discount As Single, ByVal Quantity As Short, ByVal UnitPrice As Decimal, ByVal CategoryName As String, ByVal ProductName As String, ByVal Country As String, ByVal FirstName As String, ByVal LastName As String, ByVal OrderDate As Date) As SalesPersonRow
                Dim rowSalesPersonRow As SalesPersonRow = (DirectCast(Me.NewRow(), SalesPersonRow))
                Dim columnValuesArray() As Object = { Sales_Person, Extended_Price, Discount, Quantity, UnitPrice, CategoryName, ProductName, Nothing, Country, FirstName, LastName, OrderDate}
